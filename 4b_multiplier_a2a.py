...
# 4-bit multiplier problem definition
NUM_BITS = 4
NUM_GATES = 96
LEARNING_RATE = 1e-2
...
def correct_behavior(inputs: torch.Tensor, output_shape: Tuple[int, int]) -> torch.Tensor:
    """
    Compute bitwise product and return per-bit outputs (little-endian).
    """
